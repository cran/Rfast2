...
double glm_logistic3(mat, vec, double *, vec, const double, const int);
...
//mat add_term_c(const vec &, const mat &, const mat &, const double,const std::string, const double, const bool, const bool, const int, const double);
...
vec prop_reg2(mat, vec, double *,vec, const double,const int);
